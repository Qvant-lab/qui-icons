...
```bash
# use yarn
$ yarn add @qvant/icons-svg

# or use npm
$ npm install @qvant/icons-svg --save
```

## Get started

```ts
import { AccountBookOutlined } from '@qvant/icons-svg';
// or
// import AccountBookOutlined from '@qvant/icons-svg/es/asn/AccountBookOutlined';
...
```ts
// types.d.ts
export declare type ThemeType = 'filled' | 'outlined';
...
```ts
import { AccountBookFilled } from '@qvant/icons-svg';
import { renderIconDefinitionToSVGElement } from '@qvant/icons-svg/es/helpers';
